...
- **Payment terms (owner-confirmed, September 2026)**: one fixed monthly fee paid in advance by the 1st (PayNow preferred, bank transfer, or card via HitPay); a fifth-week lesson costs nothing extra; lessons continue through the school holidays (owner's decision, 23 September 2026); missed lessons get the recording, no make-ups; one month's notice to stop. Used in the pricing FAQ "When and how do I pay?" (`#pricing-faq-pay`, opened by hash), its schema, the contact FAQ and the chatbot `payment` answer — change them together
