...
- **How**: plain words and short sentences, contractions (escape them in JS strings), sentence-case headings and buttons (proper nouns and the fixed label **Book Free Assessment** keep their capitals), British spelling, at most one em dash per paragraph, no exclamation marks outside quotes.
...
- **Booking buttons**: /about/, /results/, /testimonials/, /success-stories/ and /programmes/ have a Book Free Assessment button in the hero (first phone screen); each success story ends with one linking to `/contact/?subject=<key>`
