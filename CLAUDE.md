...
- **Free assessment process (as the owner runs it)**: the parent sends the form or a WhatsApp message; Jeremy replies on WhatsApp within 24 hours to fix a 20-minute Zoom slot; the parent sends a photo of the child's latest marked paper to +65 8991 3181 before the call; a written summary of the gaps follows. The contact page steps, both form confirmation messages and the chatbot use this wording. There is **no trial lesson** — say so wherever "free trial" is asked
