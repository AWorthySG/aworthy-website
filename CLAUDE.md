...
public/
├── images/
│   ├── logo-grade-a.webp      # Site logo (grade-a mascot icon) — on-page use (Header, Footer, chatbot, offline page). See "Brand Mascots"
...
- `public/images/mascots/mascot-grade-a-icon.webp` — the grade-a sticker with the caption and die-cut border removed (372×385); the source of the logo files and favicons.
- `public/favicon.ico` (multi-size), `public/favicon-16.png`, `public/favicon-32.png`, `public/apple-touch-icon.png` (180×180, opaque cream `#FAF6EE` background, art at 80% — Apple recommends against transparency), `public/icons/icon-{192,512}x192.png` (same opaque-cream treatment, for PWA manifest / Android home screen).
